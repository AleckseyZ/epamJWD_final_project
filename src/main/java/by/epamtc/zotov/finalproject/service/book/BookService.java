...
public interface BookService {
        ...
        /**
         * Calculates number of books of cretain kind that are currently aren't leased
         * and available
         * 
         * @param targetId ID of book type being counted
         * @return number of available books with targetID
         * @throws ServiceException
         */
