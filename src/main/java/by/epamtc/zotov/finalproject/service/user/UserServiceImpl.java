...
public class UserServiceImpl implements UserService {
    ...
    public boolean updatePassword(int targetId, char[] password, char[] newPassword, char[] repeatPassword)
        ...
        if (Arrays.equals(newPassword, repeatPassword)) {
            ...
            try {
                User user = DAOFactory.getUserDAO().findUserById(targetId);
                ...
                if (isAuthentic) {
                    ...
                    isSuccesfull = DAOFactory.getUserDAO().updatePassword(targetId, hashedPassword);
                }
            } catch (DAOException e) {
                throw new ServiceException(e);
            }
    ...
    public boolean updateEmail(int targetId, String newEmail) throws ServiceException {
        ...
        try {
            isSuccesfull = DAOFactory.getUserDAO().updateEmail(targetId, newEmail);
        } catch (DAOException e) {
            throw new ServiceException(e);
        }
    ...
    public String findUserTypeByUsername(String username) throws ServiceException {
        ...
        try {
            userType = DAOFactory.getUserDAO().findUserTypeByUsername(username);
        } catch (DAOException e) {
            throw new ServiceException(e);
        }
    ...
    public int findUserIdByUsername(String username) throws ServiceException {
        ...
        try {
            userId = DAOFactory.getUserDAO().findUserIdByUsername(username);
        } catch (DAOException e) {
            throw new ServiceException(e);
        }
    ...
    public User findUserById(int targetId) throws ServiceException {
        ...
        try {
            targetUser = DAOFactory.getUserDAO().findUserById(targetId);
        } catch (DAOException e) {
            throw new ServiceException(e);
        }
    ...
    public User findUserByUsername(String username) throws ServiceException {
        ...
        try {
            targetUser = DAOFactory.getUserDAO().findUserByUsername(username);
        } catch (DAOException e) {
            throw new ServiceException(e);
        }
    ...
    public List<String> getUserTypes() throws ServiceException {
        ...
        try {
            userTypes = DAOFactory.getUserDAO().getUserTypes();
        } catch (DAOException e) {
            throw new ServiceException(e);
        }
